...
if (firstBox) {
    const audioURL = "/.old/1.0/img/sfx/breath-loop-sfx.mp3";
    ...
    startAdventure.addEventListener("click", () => {
        ...
        const firstPassword = () => {
            ...
            switch (password) {
                ...
                case "camaleon":
                goodPassword(firstBox);
                window.open("/.old/1.0/Online/experimental/hezan.html", "_self");
                break;
                default:
        ...
        if (allCss.length <= 2) {
            addCSS("/.old/1.0/css/experimental/miyazaki.css");
        }
...
function SecondPart(){
    const SecondPassword = (password) => {    
        ...
        switch (password) {
            ...
            window.open("/.old/1.0/Online/experimental/lacey.html", "_self");
            break;
...
function FirstClue(){
    window.open("/.old/1.0/Online/experimental/first_clue.txt.html", "_self");
    let ex = ";";
}
function SecondClue(){
    window.open("/.old/1.0/Online/experimental/secret-2.txt.html", "_self");
}
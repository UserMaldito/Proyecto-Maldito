...
function VerifingNewLayout(newLayout){
    ...
    let isGallery = window.location.pathname.includes("/.old/1.0/Gallery/My-Camera-Roll/index.html"); //My Gallery?
    let newLayoutName = "";
...
function HackerCSS(folder) {
    ...
    link_1.setAttribute("href", "/.old/1.0/css/"+folder+"/fonts/fonts.css");
    link_2.setAttribute("href", "/.old/1.0/css/"+folder + "/"+ folder +".css");
    link_3.setAttribute("href", "/.old/1.0/css/"+folder+"/header/header.css");
    link_4.setAttribute("href", "/.old/1.0/css/"+folder+"/main/main.css");
    link_5.setAttribute("href", "/.old/1.0/css/"+folder+"/main/section/section.css");
    link_6.setAttribute("href", "/.old/1.0/css/"+folder+"/main/aside/aside.css");
    link_7.setAttribute("href", "/.old/1.0/css/"+folder+"/footer/footer.css");
    link_8.setAttribute("href", "/.old/1.0/css/"+folder+"/cursors/cursor.css");
    // link_9.setAttribute("href", "/.old/1.0/css/"+folder+"/images.css");
...
function BootstrapCSS(){
    ...
    if (window.location.pathname.match("/.old/1.0/Online/Gallery/My-Camera-Roll/index.html")){
        let link_2 = document.createElement("link");
        link_2.setAttribute("rel", "stylesheet");
        link_2.setAttribute("href", "/.old/1.0/css/hacker/specific/gallery/gallery.css");
        document.head.appendChild(link_2);
    }
}
...
function HackerGalleryCSS(folder) {
    ...
    link_1.setAttribute("href", "/.old/1.0/css/"+folder+"/fonts/fonts.css");
    link_2.setAttribute("href", "/.old/1.0/css/"+folder+"/cursors/cursor.css");
    link_3.setAttribute("href", "/.old/1.0/css/"+folder+"/"+ folder +".css");
    link_4.setAttribute("href", "/.old/1.0/css/"+folder+"/header/header.css");
    link_5.setAttribute("href", "/.old/1.0/css/"+folder+"/specific/gallery/gallery.css");
    link_6.setAttribute("href", "/.old/1.0/css/"+folder+"/footer/footer.css");
...
window.onload = () => {
    ...
    let isGallery = window.location.pathname.includes("/.old/1.0/Online/Gallery/My-Camera-Roll/index.html");
